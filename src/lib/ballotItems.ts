...
export const ballotItems: BallotItem[] = [
  {
    ...
    title: "Publish every public budget transfer in a real-time open ledger",
    status: "Open",
    support: "71.2%",
    turnout: "2.8M votes",
...
Departments can still move funds in emergencies, but they lose the ability to do it invisibly.`,
  },
  {
    ...
    title: "Ban public agencies from buying location data without a warrant",
    status: "Open",
    support: "68.4%",
    turnout: "2.1M votes",
...
The measure closes a surveillance loophole created by the commercial data market.`,
  },
  {
    ...
    title: "Guarantee free breakfast and lunch for every public school student",
    status: "Closing Soon",
    support: "64.7%",
    turnout: "1.6M votes",
...
The measure expands recurring education spending and requires procurement scaling.`,
  },
  {
    ...
    title: "Require bus lanes and sidewalks to be evaluated before road widening",
    status: "Open",
    support: "58.9%",
    turnout: "842K votes",
...
Residents can judge whether a widening project is actually the best use of public space.`,
  },
  {
    ...
    jurisdiction: "City",
    category: "Housing",
    title: "Cap annual rent increases for large corporate landlords",
    status: "Open",
    support: "61.5%",
    turnout: "1.2M votes",
...
The enforcement office must be staffed well enough to process complaints quickly.`,
  },
  {
    ...
    title: "Fast-track rooftop and community solar permits on public buildings",
    status: "Open",
    support: "73.8%",
    turnout: "917K votes",
...
The region moves clean-energy projects from aspiration into the normal capital pipeline.`,
  },
  {
    ...
    title: "Create an independent civilian review board for serious use-of-force cases",
    status: "Closing Soon",
    support: "66.1%",
    turnout: "1.4M votes",
...
The board needs operational independence, staffing, and protected access to evidence.`,
  },
  {
    ...
    title: "Launch a public childcare guarantee for children under five",
    status: "Draft",
    support: "59.4%",
    turnout: "603K votes",
